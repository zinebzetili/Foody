...
class PasswordRecoveryVerificationCode extends StatefulWidget {
  const PasswordRecoveryVerificationCode({Key? key}) : super(key: key);
  @override
  _PasswordRecoveryVerificationCodeState createState() => _PasswordRecoveryVerificationCodeState();
}

class _PasswordRecoveryVerificationCodeState extends State<PasswordRecoveryVerificationCode> {
  int minutes = 3;
  int seconds = 0;
  late Timer timer;
